...
public class GetFood {
    public static ArrayList<Food> getInfo(){
        ...
        //Baked Goods
        foodInfo.add(new Food("Blueberry Bagel", 2, null, null));
        foodInfo.add(new Food("Chocolate Chip Cookie", 0.85, null, null));
        foodInfo.add(new Food("Banana Nut Muffin", 2, null, null));
        //Wraps
        foodInfo.add(new Food("BBQ Chicken Wrap", 5, null, null));
        foodInfo.add(new Food("Double Egg & Cheese Wrap", 4, null, null));
        foodInfo.add(new Food("Vegetarian Chicken Wrap", 5, null, null));
        //Entrees
        foodInfo.add(new Food("Pepperoni Flatbread pizza", 5.5, null, null));
        foodInfo.add(new Food("Chicken Quesadilla", 5.5, null, null));
        //Sandwiches
        foodInfo.add(new Food("Ham Bagel Sandwich", 4, null, null));
        ...
        //Grab & Go
        foodInfo.add(new Food("Original Sun Chips", 1, null, null));
